...
def train(model_full, model_red, train_gen, test_gen, test_gen_red, starts_from, max_epochs, root_output="./default"):
    for i in range(starts_from, max_epochs):
        ...
        model_full.fit(train_gen, use_multiprocessing=True, workers=16)
...
def main(descriptor_dir, directory, root_name, max_epochs):
    ...
    print(last_epoch)
    model_full, model_red = get_model()
...
if __name__ == "__main__":
    ...
    root_name = "model_test_vJun23"
    max_epochs = 20
    descriptor_dir = Path("/srv/share/descriptors/M148/")
