...
def unet_model(n_classes=5, im_sz=320, n_channels=8, n_filters_start=32, growth_factor=2, upconv=True):
    ...
    pool4_1 = convolution_block(pool4_1, n_filters, (3, 3))
    conv4_2 = residual_block(pool4_1, n_filters)
    conv4_2 = residual_block(conv4_2, n_filters)
    ...
    up6 = convolution_block(up6, n_filters, (3, 3))
    conv6 = residual_block(up6, n_filters)
    conv6 = residual_block(conv6, n_filters)
