...
def main(args):
    ...
    for cell_type in args.cell_types:
        out_surf_name = os.path.join(os.path.dirname(args.nifti_reference), f"cell_density_{cell_type}.func.gii")
        left_metric = os.path.join(os.path.dirname(args.nifti_reference), f"cell_density_{cell_type}_L.func.gii")
        right_metric = os.path.join(os.path.dirname(args.nifti_reference), f"cell_density_{cell_type}_R.func.gii")
        dscalar = os.path.join(os.path.dirname(args.nifti_reference), f"{cell_type}_LR.dscalar.nii")
